// 1. Implementation of comparable and comparator using normal priority queue
// 2. Implementation of comparable and comparator using generic priority queue

/*                Implementation of comparable and comparator using normal priority queue   
import java.util.*;
...
public class Main {
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.println("On the basis of names");
    while (pq.size() > 0) {
...
/*                Implementation of comparable and comparator using generic priority queue
import java.util.*;
import java.io.*;
